...
save_file = 'breakout_model.p'
best_save_file = 'breakout_model_best.p'
...
try:
    while True:
        ...
        # Policy gradient: log-likelihood gradient for softmax
        dlogp = -aprob.copy()
        dlogp[action] += 1.0
        dlogps.append(dlogp)
        ...
        if done:
            ...
            # Scale each timestep's gradient by advantage

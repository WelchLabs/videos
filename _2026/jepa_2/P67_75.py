...
class p67(InteractiveScene):
    def construct(self):
        ...
        for i in tqdm(range(1, n_steps)):
            ...
            color_keyboard(actions_scaled[i])
...
class p67b(InteractiveScene):
    def construct(self):
        ...
        episode_1_imgs=Group()
        for i, p in enumerate(sorted((Path(push_t_dir_1)/'ep_0056/frames').glob('*.png'))):
            episode_1_imgs.add(ImageMobject(str(p)))
...
class p67c(InteractiveScene):
    def construct(self):
        ...
        episode_1_imgs=Group()
        for i, p in enumerate(sorted((Path(push_t_dir_1)/'ep_0057/frames').glob('*.png'))):
            episode_1_imgs.add(ImageMobject(str(p)))

...
class guidance_book_4c(InteractiveScene):
    def construct(self):
        ...
        xt_history=np.load('/Volumes/hot_1/Stephencwelch Dropbox/welch_labs/sora/hackin/conditioned_history_3.npy')
        heatmaps=np.load('/Volumes/hot_1/Stephencwelch Dropbox/welch_labs/sora/hackin/conditioned_heatmaps_3.npy')
...
class guidance_book_5(InteractiveScene):
    def construct(self):
        ...
        xt_history=np.load('/Volumes/hot_1/Stephencwelch Dropbox/welch_labs/sora/hackin/conditioned_history_5.npy')
        heatmaps=np.load('/Volumes/hot_1/Stephencwelch Dropbox/welch_labs/sora/hackin/conditioned_heatmaps_5.npy')
        heatmaps_u=np.load('/Volumes/hot_1/Stephencwelch Dropbox/welch_labs/sora/hackin/conditioned_heatmaps_5u.npy')
        heatmaps_c=np.load('/Volumes/hot_1/Stephencwelch Dropbox/welch_labs/sora/hackin/conditioned_heatmaps_5c.npy')
        model=torch.load('/Volumes/hot_1/Stephencwelch Dropbox/welch_labs/sora/hackin/jun_27_1.pt', map_location=torch.device('cpu'), weights_only=False)
...
class guidance_book_8(InteractiveScene):
    def construct(self):
        ...
        xt_history_2=np.load('/Volumes/hot_1/Stephencwelch Dropbox/welch_labs/sora/hackin/conditioned_history_6.npy')
        heatmaps_2=np.load('/Volumes/hot_1/Stephencwelch Dropbox/welch_labs/sora/hackin/conditioned_heatmaps_6.npy')
        heatmaps_u_2=np.load('/Volumes/hot_1/Stephencwelch Dropbox/welch_labs/sora/hackin/conditioned_heatmaps_6u.npy')
        heatmaps_c_2=np.load('/Volumes/hot_1/Stephencwelch Dropbox/welch_labs/sora/hackin/conditioned_heatmaps_6c.npy')
        model_2=torch.load('/Volumes/hot_1/Stephencwelch Dropbox/welch_labs/sora/hackin/jun_27_2.pt', map_location=torch.device('cpu'))
...
class guidance_book_9b(InteractiveScene):
    def construct(self):
        ...
        heatmaps_u_2=np.load('/Volumes/hot_1/Stephencwelch Dropbox/welch_labs/sora/hackin/conditioned_heatmaps_6u.npy')
        heatmaps_c_2=np.load('/Volumes/hot_1/Stephencwelch Dropbox/welch_labs/sora/hackin/conditioned_heatmaps_6c.npy')
        model_2=torch.load('/Volumes/hot_1/Stephencwelch Dropbox/welch_labs/sora/hackin/jun_27_2.pt', map_location=torch.device('cpu'), weights_only=False)
        ...
        for class_index in range(xt_history_2.shape[0]):
            for path_index in range(num_dots_per_class): 
                dot_to_move=Dot(axes.c2p(*np.concatenate((xt_history_2[class_index, 0, path_index, :], [0]))), radius=0.08) #0.06
                dot_to_move.set_color(colors_by_class[class_index])
                all_dots_to_move.add(dot_to_move)

                traced_path = CustomTracedPath(dot_to_move.get_center, stroke_color=colors_by_class[class_index], stroke_width=2.4,  #1.8
        ...
        self.frame.reorient(0, 0, 0, (np.float32(0.1), np.float32(0.21), np.float32(0.0)), 14)

        self.remove(all_dots_to_move)
        self.add(all_dots_to_move)

        self.add(vector_field_cats_u)
